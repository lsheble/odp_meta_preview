...
## Adding local government data to Data.gov: Requirements

:::{.callout-caution}
[Github issue #1168](https://github.com/CityOfDetroit/data-engineering/issues/1168) is being used to track progress on steps required to have Detroit's ODP metadata harvested by Data.gov.
:::


```{mermaid}
%%| Label: ago-to-datagov 
flowchart LR
