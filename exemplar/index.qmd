...
[Results from the Google "Rich Results Test" for our HTML display mockup](https://search.google.com/test/rich-results?url=https%3A%2F%2Flsheble.github.io%2Fodp_meta_preview%2Fexemplar%2Ffire_inspections.html) show that in addition to the "Dataset" and "Distribution" metadata, the structured format of variable-level metadata (column or variable name and description) is also identified. 
