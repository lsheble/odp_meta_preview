...
[Results from the Google "Rich Results Test" for our HTML display mockup](https://search.google.com/test/rich-results/result?id=tY06mn4sON1TQgc0xY3v4g) show that in addition to the "Dataset" and "Distribution" metadata, the structured format of variable-level metadata (column or variable name and description) is also identified. 
