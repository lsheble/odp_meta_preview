...
[Results from the Google "Rich Results Test" for our HTML display mockup](https://search.google.com/test/rich-results/result?id=rcKYOtyFXsbd02FK1-cLvQ) show that in addition to the "Dataset" and "Distribution" metadata, the structured format of variable-level metadata (column or variable name and description) is also identified. 
